...
This list is circular, means that 11 will follow 0 again. You will be g///iven the student number ‘i’ and some position ‘p’. You will have to tell that if the list will start from (i+1)th student, then which student will be at pth position.
Input Format://///
